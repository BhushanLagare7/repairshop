...
export const saveCustomerAction = actionClient
  .metadata({ actionName: "save-customer-action" })
  ...
  .action(
    async ({
      ...
      if (customer.id === 0) {
        ...
        return {
          message: `Customer ID #${result[0].insertedId} has been created successfully`,
        };
      }
      ...
      return {
        message: `Customer ID #${result[0].updatedId} has been updated successfully`,
      };
    },
  );
